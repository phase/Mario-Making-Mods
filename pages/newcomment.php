...
else if(isset($_POST['actionpost']))
{
	...
	else
	{
		...
		if($lastPost < Settings::get("floodProtectionInterval"))
		{
			...
			{
				$pid = $lastPost['id'];
				die(header("Location: ".actionLink("depotentry", 0, "pid=".$pid."#".$pid)));
			}
...
echo "
	<form name=\"postform\" action=\"".htmlentities(actionLink("newcomment", $tid))."\" method=\"post\" enctype=\"multipart/form-data\">
